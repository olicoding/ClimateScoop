    ...
    return (
      <>
        ...
        <div className="chart-citations">
          This chart displays a cumulative sum of renewable energy production
          and consumption for each country, spanning from 1997 to 2016. Data for
          China and India are capped at ~20M GWh for visualization purposes.{" "}
          <cite className="cite">
